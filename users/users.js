...
module.exports.create = ( event, context, callback ) => {
  ...
  return users.create( event )
    .then( result => {
      return callback( null, prepareResponse( 200, "Success", result ) ); // success
    } )
    .catch( err => {
      return errResponse( err, callback, 'users.create' );
    } );
};
...
module.exports.update = ( event, context, callback ) => {
  ...
  return users.update( event )
    ...
    .catch( err => {
      return errResponse( err, callback, 'users.update' );
    } );
};
...
module.exports.delete = ( event, context, callback ) => {
  ...
  return users.delete( event )
    ...
    .catch( err => {
      return errResponse( err, callback, 'users.delete' );
    } );
};
...
module.exports.getOne = ( event, context, callback ) => {
  ...
  return users.getOne( event )
    .then( result => {
      return callback( null, prepareResponse( 200, "Success", result ) ); // success
    } )
    .catch( err => {
      return errResponse( err, callback, 'users.getOne' );
    } );
};
